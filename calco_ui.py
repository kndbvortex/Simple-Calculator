...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(688, 543)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("image/calculate-math.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("image/Dk.jpg"))
        ...
        self.splitter.setMaximumSize(QtCore.QSize(1000, 67))
        self.splitter.setOrientation(QtCore.Qt.Vertical)
        self.splitter.setObjectName("splitter")
        self.label_operation = QtWidgets.QLabel(self.splitter)
        self.label_operation.setMaximumSize(QtCore.QSize(1000, 33))
...
"")
        ...
        self.label_resultat.setMaximumSize(QtCore.QSize(1000, 33))
...
"")
        ...
        self.comboBox_fonctions = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_fonctions.setStyleSheet("background-color : #1e90ff;\n"
"font: 25 12pt \"Exo\";")
        ...
        self.comboBox_fonctions.addItem("")
        self.comboBox_fonctions.addItem("")
        self.horizontalLayout_5.addWidget(self.comboBox_fonctions)
        ...
        self.bouton_delete.setStyleSheet("background-color : #1e90ff;\n"
"font: 25 12pt \"Exo\";")
        ...
        self.bouton_clear_all.setStyleSheet("background-color : #1e90ff;\n"
"font: 25 12pt \"Exo\";")
        ...
        self.bouton_multiplication.setStyleSheet("background-color : #1e90ff;\n"
"font: 25 12pt \"Exo\";")
        ...
        self.bouton_division.setStyleSheet("background-color : #1e90ff;\n"
"font: 25 12pt \"Exo\";")
        ...
        self.bouton_addition.setStyleSheet("background-color : #1e90ff;\n"
"font: 25 12pt \"Exo\";")
        ...
        self.bouton_moins.setStyleSheet("background-color : #1e90ff;\n"
"font: 25 12pt \"Exo\";")
        ...
        self.bouton_ans.setStyleSheet("background-color : #1e90ff;\n"
"font: 25 12pt \"Exo\";")
        ...
        self.bouton_egal.setStyleSheet("background-color : #1e90ff;\n"
"font: 25 12pt \"Exo\";")
        ...
        spacerItem7 = QtWidgets.QSpacerItem(20, 14, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_fonctions.setItemText(4, _translate("MainWindow", "log(x)"))
        self.comboBox_fonctions.setItemText(5, _translate("MainWindow", "ln(x)"))
        self.comboBox_fonctions.setItemText(6, _translate("MainWindow", "sin(x)"))
        self.comboBox_fonctions.setItemText(7, _translate("MainWindow", "sin⁻¹(x)"))
        self.comboBox_fonctions.setItemText(8, _translate("MainWindow", "tan(x)"))
